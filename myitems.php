  ...
  <body>
     ...
     <div class="jumbotron">
       ...
       <form class="form-inline" action="dbconnect.php">
        ...
        <input class="form-control mr-sm-2" type="text" placeholder="Item Price" name="itemPrice">
        <input class="form-control mr-sm-2" type="radio" placeholder="Potion" name="itemPotion">
        <label for="radio">Potion</label>
        <input class="form-control mr-sm-2" type="radio" placeholder="Ingredient" name="itemIngredient">
